    ...
    <form method="post">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="nom" name="nom" value="${empty updateConseiller ? '' : updateConseiller.nom}">
            </div>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control" name="codePostal" id="codePostal" value="${empty updateConseiller ? '' : updateConseiller.codePostal}">
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="email" class="form-control" name="mail" id="mail" value="${empty updateConseiller ? '' : updateConseiller.mail}">
            </div>
        ...
        <div class="form-group text-center">
            <button style ="text-align:center" type="submit" class="btn btn-primary">Créer un conseiller</button>
    </form>
</div>
